...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addAttachmentOption(option => 
            option.setName('image')
                .setDescription('A chess board image to analyze')
                .setRequired(true))
    ...
    async execute(interaction) {
        try {
            ...
            const pythonArgs = [
                path.join(solverDir, 'chess_solve.py'),
                imagePath
            ];
            ...
            try {
                ...
                const responseEmbed = {
                    ...
                    fields: [
                        ...
                        { name: 'Board Orientation', value: `${bottomColor.charAt(0).toUpperCase() + bottomColor.slice(1)} pieces on bottom`, inline: false }
                    ],
                ...
                await interaction.editReply("Couldn't find chessboard in image.");
            }
