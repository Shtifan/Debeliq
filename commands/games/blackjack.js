...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const buttons = new ActionRowBuilder().addComponents(
            ...
            new ButtonBuilder().setCustomId("double").setLabel("Double").setStyle(ButtonStyle.Success).setDisabled(!gameState.canDouble),
            new ButtonBuilder().setCustomId("surrender").setLabel("Surrender").setStyle(ButtonStyle.Danger).setDisabled(!gameState.canSurrender)
        );
    ...
    async handleButton(interaction) {
        ...
        embed.addFields(
            { name: "Your Hand", value: `${formatHand(gameState.playerHand)} (${calculateHandValue(gameState.playerHand)})` },
            { name: "Dealer's Hand", value: `${formatHand(gameState.dealerHand)} (${calculateHandValue(gameState.dealerHand)})` },
